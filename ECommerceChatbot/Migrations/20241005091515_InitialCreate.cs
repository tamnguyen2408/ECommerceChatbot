    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductProductCategories", x => new { x.CategoriesCategoryID, x.ProductsProductID });
                    table.ForeignKey(
                        name: "FK_ProductProductCategories_ProductCategories_CategoriesCategoryID",
                        column: x => x.CategoriesCategoryID,
                        principalTable: "ProductCategories",
                        principalColumn: "CategoryID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductProductCategories_Products_ProductsProductID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatbotInteractions_Users_UserID",
                        column: x => x.UserID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductProductCategories_ProductsProductID",
